...
# etc
# Inicializacion de la funcion propagacion
def propagacion():
    # Importa los modulos numpy y matplotlib, estos permiten en trabajo con matrices y graficas
    import numpy as np
    ...
    if simb == 1:
        ...
        # en esta seccion se calculan los diferenciales de temperatura
        while t < tf:
            for i in range(nx):
                for j in range(ny):
                    ti = TS[i, j]
        ...
        # el codigo finaliza en este punto cuando el usuario ingrese un valor de material que no esta en la lista
        print("***********************************************************************")
...
# esta parte llama la funcion de propagacion ya que no se esta usando desde un codigo externo
propagacion()
